...
public:
   ...
   * @param can_slew_down Set to false to disable slewing if slowing down. But
   * set to true to slew downwards too
   * @param milliseconds_per_step The amount of milliseconds per step
   * (recommended to be 10ms)
   */
  Slew(double max_increase_per_second, bool can_slew_down = false,
       int milliseconds_per_step = 10);

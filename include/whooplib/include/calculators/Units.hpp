...
namespace whoop {
    ...
    constexpr long double operator"" _v(long double volts) {
        return volts;
    }

    constexpr long double operator"" _v(unsigned long long volts) {
        return volts;
    }
    ...
    constexpr long double operator"" _sec(long double seconds) {
        return seconds;
    }
    ...
    constexpr long double operator"" _kp(long double kp) {
        return kp;
    }

    constexpr long double operator"" _kp(unsigned long long kp) {
        return kp;
    }

    // Integral gain remains the same
    constexpr long double operator"" _ki(long double ki) {
        return ki;
    }

    constexpr long double operator"" _ki(unsigned long long ki) {
        return ki;
    }

    // Derivative gain remains the same
    constexpr long double operator"" _kd(long double kd) {
        return kd;
    }

    constexpr long double operator"" _kd(unsigned long long kd) {
        return kd;
    }
}

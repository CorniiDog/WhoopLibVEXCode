...
PurePursuitConductor::PurePursuitConductor(PursuitParams* default_pursuit_parameters):
    turn_pid(0, default_pursuit_parameters->turning_kp, default_pursuit_parameters->turning_ki, default_pursuit_parameters->turning_kd, default_pursuit_parameters->turning_i_activation, default_pursuit_parameters->settle_rotation, default_pursuit_parameters->settle_time, default_pursuit_parameters->timeout),
...
PursuitResult PurePursuitConductor::step(TwoDPose current_pose){
    if(!enabled){ // If not enabled, set is_valid as true and is_completed as true

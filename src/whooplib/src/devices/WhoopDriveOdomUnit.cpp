...
WhoopDriveOdomUnit::WhoopDriveOdomUnit(double forward_tracker_distance, double forward_tracker_wheel_diameter_meters, double sideways_tracker_distance, double sideways_tracker_wheel_diameter_meters, WhoopInertial *inertialSensor, WhoopRotation *forward_tracker, WhoopRotation *sideways_tracker) : inertial_sensor(inertialSensor)
{
...
WhoopDriveOdomUnit::WhoopDriveOdomUnit(double drive_width, double drive_wheel_diameter_meters, double drive_gear_ratio, WhoopInertial *inertialSensor, std::vector<WhoopMotor *> leftMotors, std::vector<WhoopMotor *> rightMotors) : inertial_sensor(inertialSensor)
{
...
WhoopDriveOdomUnit::WhoopDriveOdomUnit(double drive_center_distance, double drive_wheel_diameter_meters, double drive_gear_ratio, double sideways_tracker_distance, double sideways_tracker_wheel_diameter_meters, WhoopInertial *inertialSensor, WhoopRotation *sideways_tracker, std::vector<WhoopMotor *> leftMotors, std::vector<WhoopMotor *> rightMotors) : inertial_sensor(inertialSensor)
{
    init_motor_groups(leftMotors, rightMotors);
    set_motor_ratio_and_diameter(drive_wheel_diameter_meters, drive_gear_ratio);
    this->sideways_tracker = sideways_tracker;

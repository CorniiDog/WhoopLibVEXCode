...
#if USE_VEXCODE
  double yaw =
      -(vex::inertial::heading(rotationUnits::deg) * correction_multiplier);
#else
...
double WhoopInertial::get_yaw_degrees() { return this->get_yaw(); }

double WhoopInertial::get_yaw_radians() { return to_rad(this->get_yaw()); }
...
double WhoopInertial::get_roll_degrees() { return get_roll(); }

double WhoopInertial::get_roll_radians() { return to_rad(get_roll()); }
...
double WhoopInertial::get_pitch_degrees() { return get_pitch(); }

double WhoopInertial::get_pitch_radians() { return to_rad(get_pitch()); }
...
// Tare (reset)
void WhoopInertial::tare() { this->tare(0); }
...
void WhoopInertial::tare_degrees(double degrees) { this->tare(degrees); }
